describe('movie details spec', () => {
  ...
  it('displays movie details on page load', () => {
    ...
    cy.get('.movie-details').first().find('img').should('have.attr', 'src', 'https://image.tmdb.org/t/p/original//nMKdUUepR0i5zn0y1T4CsSB5chy.jpg')
    cy.get('.movie-details').first().find('img').should('have.attr', 'alt', 'Movie details for The Dark Knight')
  ...
  it('displays movie details on page load', () => {
    ...
    cy.get('.movie-details').last().find('img').should('have.attr', 'src', "https://image.tmdb.org/t/p/original//suaEOtk1N1sgg2MTM7oZd2cfVp3.jpg")
    cy.get('.movie-details').last().find('img').should('have.attr', 'alt', 'Movie details for Pulp Fiction')
    cy.get('.genre').contains("Thriller")
    cy.get('.genre').contains("Crime")
