...
describe('Main Page', () => {
  ...
  it('displays movie posters on page load', () => {
    ...
    cy.get('.movie-poster').first().find('div.vote-banner').should('exist')
    cy.get('div.vote-banner').first().find('button').should('exist')
    cy.get('div.vote-banner').first().find('p').should('contain', 32544)
    ...
    cy.get('.movie-poster').last().find('div.vote-banner').should('exist')
    cy.get('div.vote-banner').last().find('button').should('exist')
    cy.get('div.vote-banner').last().find('p').should('contain', 27642)
